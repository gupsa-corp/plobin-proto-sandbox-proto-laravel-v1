...
namespace App\Services\Rfx\DocumentAsset\UpdateHelpfulContent;
...
class Service
{
    public function execute(string $assetId, string $newHelpfulContent): array
    {
        DB::beginTransaction();
        ...
        try {
            ...
            DB::table('rfx_summary_versions')->insert([
                ...
                'helpful_content' => $newHelpfulContent,
                'edited_by' => 'user',
                'created_at' => now(),
            ]);
