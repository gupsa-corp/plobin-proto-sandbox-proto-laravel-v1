...
namespace Tests\Feature\Pms\KanbanBoard\ReviewProgressMoreThan80;
...
class Test extends TestCase
{
    ...
    public function test_진행률이_80퍼센트_이상인_프로젝트를_review로_이동하면_진행률이_유지된다(): void
    {
        // in_progress 상태이며 진행률이 90%인 프로젝트 생성
        ...
        // 진행률이 유지되는지 확인
        $this->assertEquals(90, $project->progress, '진행률이 유지되어야 합니다');
    }
}
