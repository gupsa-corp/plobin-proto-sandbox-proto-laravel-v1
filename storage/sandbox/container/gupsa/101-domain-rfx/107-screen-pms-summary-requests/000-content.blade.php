            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="p-2 bg-yellow-100 rounded-lg">
                        <i class="fa fa-clock w-6 h-6 text-yellow-600"></i>
                    </div>
                    <div class="ml-4">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="p-2 bg-blue-100 rounded-lg">
                        <i class="fa fa-bolt w-6 h-6 text-blue-600"></i>
                    </div>
                    <div class="ml-4">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="p-2 bg-green-100 rounded-lg">
                        <i class="fa fa-check-circle w-6 h-6 text-green-600"></i>
                    </div>
                    <div class="ml-4">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="p-2 bg-red-100 rounded-lg">
                        <i class="fa fa-exclamation-triangle w-6 h-6 text-red-600"></i>
                    </div>
                    <div class="ml-4">
...
async function loadSummaryRequests() {
    try {
        ...
        const response = await fetch(`/api/sandbox/gupsa/rfx/pms-summary-requests?${params}`, {
            headers: {
...
async function loadStatistics() {
    try {
        const response = await fetch('/api/sandbox/gupsa/rfx/pms-summary-statistics', {
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || ''
            }
        });
...
function getPriorityIcon(priority) {
    const icons = {
        'urgent': '<i class="fa fa-star h-8 w-8 text-red-500"></i>',
        'high': '<i class="fa fa-bolt h-8 w-8 text-orange-500"></i>',
        'medium': '<i class="fa fa-clock h-8 w-8 text-yellow-500"></i>',
        'low': '<i class="fa fa-star h-8 w-8 text-green-500"></i>'
    };
...
async function submitSummaryRequest() {
    try {
        ...
        const response = await fetch('/api/sandbox/gupsa/rfx/pms-summary-request', {
            method: 'POST',
            headers: {
...
async function showSummaryDetails(requestId) {
    try {
        const response = await fetch(`/api/sandbox/gupsa/rfx/pms-summary-requests/${requestId}`, {
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || ''
            }
        });
