...
<div class="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 p-6"
    ...
    <div x-show="!isLoading && (!documentData.assets || documentData.assets.length === 0)" class="text-center py-12">
        ...
        <a href="javascript:history.back()" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
            <i class="fa fa-cog w-4 h-4 mr-2"></i>
            파일 목록으로 돌아가기
        </a>
    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-2 flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div x-show="!isEditing(index, 'ai_summary') && asset.summary?.versions?.length > 1" class="flex items-center space-x-1">
                                        ...
                                        <select @change="switchSectionVersion(index, $event.target.value)"
                            ...
                            <div class="bg-green-50 p-3 rounded-lg">
                                {{-- 현재 버전 정보 표시 --}}
                                <div x-show="!isEditing(index, 'ai_summary') && asset.summary?.versions?.length > 0"
                                     class="mb-2 pb-2 border-b border-green-200">
                                    <template x-for="version in asset.summary?.versions || []" :key="version.id">
                                ...
                                <div x-show="isEditing(index, 'ai_summary')" class="space-y-3">
                                    <textarea x-model="editingContent[index]['ai_summary']"
                ...
                3: [ // 시장 분석 리포트
                    {
                        ...
                        order_index: 1,
                        content: 'AI 솔루션 시장에서 한국 기업들의 글로벌 경쟁력은 아직 부족하지만, 특정 분야(제조업 AI, 의료 AI)에서는 세계적 수준의 기술력을 보유하고 있습니다.\n\n특히 삼성, LG, 현대차 등 대기업들의 AI 투자가 활발해지면서 B2B AI 솔루션 수요가 급증하고 있습니다. 2025년 한국 AI 시장 규모는 전년 대비 42% 성장한 12조원에 달할 것으로 예상됩니다.',
                        summary: {
                            id: 6,
