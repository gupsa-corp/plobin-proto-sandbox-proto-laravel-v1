    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button @click="openCreateModal()" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">+ 티켓 추가</button>
            </div>
        </div>
    </div>
        ...
        async loadGanttData() {
            try {
                ...
                if (result.data && Array.isArray(result.data)) {
                    ...
                    console.error('간트 차트 API 오류:', '데이터 없음');
                }
            } catch (error) {
            ...
            try {
                const response = await fetch(`/api/sandbox/gupsa/pms/projects/${this.selectedProject.id}`, {
                    ...
                    body: JSON.stringify({
                        ...
                        team_members: this.selectedProject.team_members,
