...
include storage_path(env('SANDBOX_ROOT_PATH', 'sandbox') . "/{$currentSandbox}/100-domain-pms/103-screen-table-view/305-sidebar-form.blade.php");
?>
        </div>
