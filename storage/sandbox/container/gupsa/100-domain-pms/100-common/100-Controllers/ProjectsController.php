...
class ProjectsController extends Controller
{
     ...
     * @param string|null $sandboxTemplate
     * @return JsonResponse
     */
    public function index(Request $request, string $sandboxTemplate = null): JsonResponse
    {
        // 기본 샌드박스 템플릿 설정
        if ($sandboxTemplate === null) {
            throw new \Exception('Sandbox template is not set.');
        }
    ...
    {
        $dbPath = storage_path("../" . env('SANDBOX_BASE_PATH', 'sandbox/container') . "/{$sandboxTemplate}/100-domain-pms/100-common/200-Database/release.sqlite");
