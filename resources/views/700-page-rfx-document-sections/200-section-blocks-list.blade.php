                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center space-x-2 mb-2">
                                ...
                                <span class="px-2 py-1 text-xs rounded {{ $block['block_type'] === 'title' ? 'bg-green-100 text-green-800' : ($block['block_type'] === 'paragraph' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800') }}">
                                    {{ $block['block_type'] }}
                                </span>
