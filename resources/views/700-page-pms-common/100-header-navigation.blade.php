    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="flex space-x-1">
                ...
                <a href="{{ route('pms.api-docs') }}"
                   class="px-4 py-2 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('pms.api-docs') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                    API문서
                </a>

                <a href="{{ route('pms.bookmarks') }}"
                   class="px-4 py-2 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('pms.bookmarks') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                    북마크
                </a>
            </nav>
        </div>
