    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                ...
                <!-- API 문서 -->
                <a href="/pms/api-docs" class="block bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-blue-300 transition-all">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900">API 문서</h3>
                            <p class="text-sm text-gray-500">API 엔드포인트</p>
                        </div>
                    </div>
                </a>

                <!-- 북마크 관리 -->
                <a href="/pms/bookmarks" class="block bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-blue-300 transition-all">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900">북마크 관리</h3>
                            <p class="text-sm text-gray-500">즐겨찾기 링크</p>
                        </div>
                    </div>
                </a>
