    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                ...
                <!-- AI 분석 -->
                <a href="/rfx/ai-analysis" class="block bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-purple-300 transition-all">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900">AI 분석</h3>
                            <p class="text-sm text-gray-500">AI 문서 분석</p>
                        </div>
                    </div>
                </a>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                ...
                <!-- SSO 테스트 -->
                <a href="/sso/test" class="block bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-green-300 transition-all">
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mr-3">
                            <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h3 class="font-medium text-gray-900">SSO 테스트</h3>
                            <p class="text-sm text-gray-500">Keycloak SSO 인증 테스트</p>
                        </div>
                    </div>
                </a>
